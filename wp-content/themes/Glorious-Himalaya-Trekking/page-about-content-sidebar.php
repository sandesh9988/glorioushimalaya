...
<div class="main-wrapper">
	...
	<div class="container">
					...
					if ( is_page( 'Team' )  ) {?>
						<div class="team-section ">
							<ul class="nav nav-tabs" id="teamTab" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link" id="trekkers-tab" data-toggle="tab" href="#trekkers" role="tab" aria-controls="trekkers" aria-selected="false">Guide</a>
								</li>
							</ul>
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade show active" id="admin" role="tabpanel" aria-labelledby="admin-tab"><?php 
								$args = array(
									'tax_query' => array(
										array(
        ...
        <input type="hidden" name="fname" />
                 ...
                 <div class="field-wrap"><div class="content-column col_half"><label>Trip Name </label></div>
<div class="content-column col_last last_column"><input class="form-control" type="text" name="trip_name" required="" placeholder="Trip Name" /></div></div>
