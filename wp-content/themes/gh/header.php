                ...
                <div class="header__info">
                    <div class="header__info-wrapper">
                        <div class="header__contact">
                            ...
                            <a href="tel:+977 1 4259 098"> <svg class="icon icon-icon-phone">
                                    <use xlink:href="#icon-icon-phone"></use>
                                </svg> +977 1 4259 098</a>
                        </div>
                    </div>
                    ...
                    <div class="header__details">
                        <div class="header__details-phoneNo">
                            ...
                            <a href="viber://add?number=9851069558"><svg class="icon icon-icon-viber">
                                    <use xlink:href="#icon-icon-viber"></use>
                                </svg></a>

                            <a href="tel:+977 9851069558">+977 9851069558</a>
                        </div>
                        <div class="header__email">

                            <a href="mailto:info@glorioushimalaya.com"> <svg class="icon icon-icon-email">
                                    <use xlink:href="#icon-icon-email"></use>
                                </svg> info@glorioushimalaya.com</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="header__mainNav">
            <div class="container">
                <ul class="header__navList">
                    <li class="header__navLinks"><a href="#">Home</a></li>
